...
public class TestConfig{
	...
	public static String from = "kessalhiDC@gmail.com";
	public static String password = "Rahmoune@72";
	public static String[] to ={"seleniumcoaching@gmail.com","kessalhiDC@gmail.com"};
